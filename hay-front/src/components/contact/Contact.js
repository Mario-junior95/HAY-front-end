  ...
  return (
    <div>
      ...
      <div className="contact-banner">
        <div className="join__us__contact__title" style={{paddingBottom:"18%"}}>
          {/* <h1 className="title____contact_front">Contact us</h1> */}
        <h1 style={{paddingTop:"10%" , fontSize:"40px"}} className="title">Contact Us</h1>
         <h3>You can always feel free to contact us for inquiries,<br></br> requests and other concerns.</h3>
        </div>
        </div>
            <img data-aos="fade-left" style={{marginTop:"5%"}} className="contact__us__img" src={Logo} alt="" width="400px" />
      ...
      <span style={{"--i":9}}>s</span>
            ...
            <textarea
              ...
              placeholder="Message" style={{borderRadius:"25px"}}
              value={message}
              cols="26"
              rows="5"
              ...
              required
            />
            <button id="signin" style={{borderRadius:"15px" , width:"30%"}}
